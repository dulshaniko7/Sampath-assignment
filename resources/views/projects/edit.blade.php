                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="project_name" id="project_name"
                                           placeholder="Project Name" value="{{ old('project_name', $project->project_name) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="project_code" id="project_code"
                                           placeholder="Project code" value="{{ old('project_code', $project->project_code) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="projected_cost" id="projected_cost"
                                           placeholder="Project Cost" value="{{ old('projected_cost', $project->projected_cost) }}" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
